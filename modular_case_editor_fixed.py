...
class SetSignalRow(QWidget):
    ...
    def set_data(self, s: SetSignalModel) -> None:
        ...
        self.name_edit.setText(s.name or "")
...
class CheckItemRow(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        l3.addWidget(QLabel("timeout:", row3))
    ...
    def _on_mode_changed(self, mode: str) -> None:
        ...
        if mode == "single":
            self.op_combo.show()
            self.single_edit.show()
            self.list_edit.hide()
            self.range_a_edit.hide()
            self.range_b_edit.hide()
        elif mode == "list":
            self.op_combo.hide()
            self.single_edit.hide()
            self.list_edit.show()
            self.range_a_edit.hide()
            self.range_b_edit.hide()
        else:  # range
